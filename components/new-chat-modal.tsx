                  ...
                  >
                    <ProfileImage
                      src={user.profilePictureFileId ||
                           ...
                           null}
                      alt={user.userName || `${user.firstName} ${user.lastName}`.trim() || 'User'}
                      size="sm"
